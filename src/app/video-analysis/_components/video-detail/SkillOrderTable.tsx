...
export function SkillOrderTable({
  ...
  return (
    ...
    >
      <h4 className="text-lg font-semibold mb-4">{t("videoAnalysis.skillOrder.title")}</h4>
          ...
          <thead>
            <tr className="border-b">
              <th className="text-left py-2 px-3 font-medium text-sm whitespace-nowrap">
                {t("videoAnalysis.skillOrder.colOrder")}
              </th>
              <th className="text-left py-2 px-3 font-medium text-sm whitespace-nowrap">
                {t("videoAnalysis.skillOrder.colParty")}
              </th>
              <th className="text-left py-2 px-3 font-medium text-sm whitespace-nowrap">
                {t("videoAnalysis.skillOrder.colCharacter")}
              </th>
              <th className="text-left py-2 px-3 font-medium text-sm whitespace-nowrap">
                {t("videoAnalysis.skillOrder.colCost")}
              </th>
              <th className="text-left py-2 px-3 font-medium text-sm whitespace-nowrap">
                {t("videoAnalysis.skillOrder.colRemainingTime")}
              </th>
              <th className="text-left py-2 px-3 font-medium text-sm whitespace-nowrap">
                {t("videoAnalysis.skillOrder.colDescription")}
              </th>
            </tr>
          </thead>
          <tbody>
            {skillOrders.map((skill, index) => {
              ...
              let characterName = t("videoAnalysis.skillOrder.unknownCharacter");
              let characterCode = 0;
              ...
              return (
                <tr key={index} className="border-b hover:bg-muted/50">
                  ...
                  <td className="py-2 px-3 text-sm whitespace-nowrap">
                    {t("videoAnalysis.skillOrder.partyN").replace("{n}", String(skill.partyNumber))}
                  </td>
